...
def build_concate():
    left_hand_input = Input(shape=(8, 3, 1), name='left_hand')
    right_hand_input = Input(shape=(8, 3, 1), name='right_hand')
    head_input = Input(shape=(8, 3, 1), name='head')
    spine_input = Input(shape=(8, 3, 1), name='spine')
    left_wrist_input = Input(shape=(8, 3, 1), name='left_wrist')
    right_wrist_input = Input(shape=(8, 3, 1), name='right_wrist')
    person_input = Input(shape=(8, 1, 1), name='who')
    ...
    person_features = Conv2D(16, (3, 1), activation='relu')(person_input)
